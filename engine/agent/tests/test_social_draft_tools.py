...
from dawei.social import bridge as bridge_module
from dawei.social import session_context
from dawei.tools.custom_tools import social_draft_tools as sdt
...
class TestRegistration:
    def test_s7_group_matches_tools(self):
        ...
        group = TOOL_GROUPS.get("social", {}).get("custom_tools", [])
        assert group == [
...
class TestGenerateImages:
    def test_m2_tool_registers_ids_and_endpoint_serves(self, monkeypatch):
        ...
        from dawei.social import router as router_mod
        from dawei.social import service as svc
        from dawei.tools.custom_tools import social_draft_tools as sdt2
