...
from dawei.social import service as service_module
from dawei.social.artifact_schema import (
    ArtifactSchemaError,
    extract_structured_output,
    to_content_payload,
)
from dawei.social.service import (
    _extract_image,
    build_image_prompt,
...
def client(monkeypatch):
    from dawei.social import router as social_router_module
...
class TestProviderSelection:
    def test_pv1_resolve_by_name_then_current_fallback(self):
        ...
        from dawei.social.service import _resolve_config
