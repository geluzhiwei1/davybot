...
import dawei.tools.custom_tools.normflow_tools as nft
from dawei.tools.custom_tools._service_client import ServiceAuthError, ServiceUnavailableError
from dawei.tools.custom_tools.normflow_tools import NORMFLOW_TOOLS
...
def test_tool_groups_match_tool_classes():
    group_names = set(TOOL_GROUPS["normflow"]["custom_tools"])
...
def test_catalog_entries_match_tools():
    cat = {e.name for e in _CATALOG if e.group == "normflow"}
