...
def client():
    ...
    from dawei.api import deep_research, deep_research_product
...
class TestIndustryLifecycle:
    ...
    def test_executor_is_shared_generic_class(self):
        ...
        from dawei.workspace.industry_research_service import industry_research_service
        from dawei.workspace.product_survey_executor import ProductSurveyExecutor
...
class TestIndustryModeTeamRegistered:
    ...
    def test_industry_team_modes_ssot_in_market(self):
        ...
        from dawei.workspace.industry_research_service import MODE_TEAM_MODES
    ...
    def test_team_modes_cover_all_stage_modes(self):
        ...
        from dawei.workspace.industry_research_service import MODE_TEAM_MODES, SPEC
...
class TestIndustryRealExecution:
    ...
    def _install_fake_agent(self, monkeypatch, fail_stages=None):
        ...
        from dawei.workspace.industry_research_service import SPEC
    ...
    def test_industry_real_lifecycle(self, monkeypatch, isolated_home):
        ...
        from dawei.workspace.industry_research_service import industry_research_service as svc
...
class TestDaoHistory:
    def test_reject_archives_and_history_endpoint(self, client, isolated_home):
        from dawei.workspace.product_survey_service import product_survey_service as svc
...
class TestMdToHtml:
    def test_structure_and_escaping(self):
        from dawei.workspace.deep_research_framework import md_to_html
