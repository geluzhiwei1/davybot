...
class EvolutionCycleManager:
    ...
    async def _create_cycle_task_graph(self, cycle_id: str, prev_cycle_id: str | None):
        ...
        task_graph = TaskGraph(task_id=task_graph_id, workspace_id=self.workspace.workspace_info.id if self.workspace.workspace_info else None, event_bus=event_bus)
