...
class TaskEventType(Enum):
    ...
    # ========== 子任务生命周期 (P3-6, 6个) ==========
    # payload: subtask_id / parent_id / conversation_id / agent / depth (dawei.agentic.subtask_events)
    SUBTASK_CREATED = "subtask_created"  # new_task/run_task 创建子任务
    SUBTASK_STARTED = "subtask_started"  # 子任务开始执行
    ...
    MEMORY_READY = "memory_ready"  # 记忆系统恢复就绪（重试成功后）
