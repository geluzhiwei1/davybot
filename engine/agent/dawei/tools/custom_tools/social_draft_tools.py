...
from dawei.social import bridge, session_context
...
class SocialGenerateImagesTool(CustomBaseTool):
    ...
    def _run(self, prompt: str, count: int = 2, style: str = "", ratio: str = "") -> str:
        ...
        from dawei.social import service as social_service
...
__all__ = ["SOCIAL_DRAFT_TOOLS", "IMAGE_REGISTRY"] + [c.__name__ for c in SOCIAL_DRAFT_TOOLS]
