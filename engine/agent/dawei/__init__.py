...
# 版本信息 — use setuptools_scm auto-generated version if available
try:
    from ._version import __version__, __version_tuple__, version, version_tuple  # noqa: F811
except ImportError:
    __version__ = "1.0.0"
...
def get_dawei_home() -> Path:
    """从环境变量获取DAWEI_HOME，默认值为 ~/.normnomos
    Returns:
        str: 工作区根目录的绝对路径
    """
    dawei_home = os.environ.get("DAWEI_HOME", "~/.normnomos")
