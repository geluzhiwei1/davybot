...
class TemplateRenderer:
    ...
    def render_string(self, template_string: str, context: Dict[str, Any]) -> str:
        ...
        try:
            # Create a sandboxed Jinja2 template to prevent SSTI.
            # Without a sandbox, user-controlled template strings could
            # access Python builtins via __mro__ / __subclasses__ chains.
    ...
    def extract_variables(self, template_string: str) -> List[str]:
        ...
        """
        try:
            # Use a sandboxed environment for variable extraction
