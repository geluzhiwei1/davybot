...
def _validate_fts_filter_key(key: str) -> str:
    ...
    async def search(
        ...
        async with aiosqlite.connect(self.db_path) as db:
            ...
            try:
                ...
                # Convert BM25 score to similarity score (0-1, higher is better)
                ...
                for chunk_id, bm25_score in rows:
                    ...
                    similarity_score = abs_score / (1.0 + abs_score)
