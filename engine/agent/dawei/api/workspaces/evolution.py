...
@router.post("/enable")
async def enable_evolution(workspace_id: str, request: Request, config: EvolutionConfigRequest):
    """启用evolution功能
...
async def disable_evolution(workspace_id: str, request: Request):
    """禁用evolution功能
...
async def get_evolution_status(workspace_id: str, request: Request):
    """获取evolution状态
...
async def trigger_evolution(workspace_id: str, request: Request, body: TriggerEvolutionRequest | None = None):
    """手动触发evolution cycle
...
async def pause_cycle(workspace_id: str, request: Request, cycle_id: str):
...
async def resume_cycle(workspace_id: str, request: Request, cycle_id: str):
...
async def abort_cycle(workspace_id: str, request: Request, cycle_id: str, reason: str = ""):
...
async def get_cycle_detail(workspace_id: str, request: Request, cycle_id: str):
    """获取evolution cycle详情
...
async def delete_cycle(workspace_id: str, request: Request, cycle_id: str):
