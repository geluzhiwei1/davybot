...
@router.get("/{workspace_id}/ui-environments")
async def get_workspace_ui_environments(workspace_id: str, request: Request):
    """获取工作区的UI环境配置"""
...
@router.put("/{workspace_id}/ui-environments")
async def update_workspace_ui_environments(workspace_id: str, request: Request, ui_update: UIEnvironmentsUpdate):
    """更新工作区的UI环境配置"""
    workspace = await get_user_workspace(workspace_id, request)
    await _ensure_workspace_initialized(workspace)
...
@router.get("/{workspace_id}/ui-context")
async def get_workspace_ui_context(workspace_id: str, request: Request):
    """获取工作区的UI上下文"""
    workspace = await get_user_workspace(workspace_id, request)
    await _ensure_workspace_initialized(workspace)
...
@router.put("/{workspace_id}/ui-context")
async def update_workspace_ui_context(workspace_id: str, request: Request, context_update: UIContextUpdate):
    """更新工作区的UI上下文"""
    workspace = await get_user_workspace(workspace_id, request)
    await _ensure_workspace_initialized(workspace)
...
@router.get("/{workspace_id}/system-environments")
async def get_workspace_system_environments(workspace_id: str, request: Request):
    """获取工作区的系统环境配置"""
    workspace = await get_user_workspace(workspace_id, request)
    await _ensure_workspace_initialized(workspace)
...
@router.put("/{workspace_id}/system-environments")
async def update_workspace_system_environments(workspace_id: str, request: Request, system_update: SystemEnvironmentsUpdate):
    """更新工作区的系统环境配置"""
    workspace = await get_user_workspace(workspace_id, request)
    await _ensure_workspace_initialized(workspace)
