...
if TYPE_CHECKING:
    ...
    from dawei_biz.bridges.social.service import LlmCall
...
def run_duty_pipeline(
    ...
    *,
    ...
    """
    from dawei_biz.bridges.social.artifact_schema import to_content_payload
    ...
    if generate is None:
        from dawei_biz.bridges.social.service import generate_variants
