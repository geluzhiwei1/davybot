...
def app():
    ...
    from dawei_biz.routers import deep_research_product
...
class TestModeTeamRegistered:
    def test_product_survey_team_modes_ssot_in_market(self):
        ...
        from dawei_biz.services.product_survey_service import MODE_TEAM_MODES, SPEC
...
class TestRealExecution:
    ...
    @staticmethod
    def _svc():
        from dawei_biz.services.product_survey_service import product_survey_service
    ...
    def _install_fake_agent(self, monkeypatch, fail_stages=None, candidates=None):
        ...
        from dawei_biz.services.product_survey_service import STAGE_ARTIFACTS
    ...
    def test_real_without_executor_fast_fail(self):
        from dawei_biz.services.product_survey_service import ProductSurveyError, ProductSurveyService
