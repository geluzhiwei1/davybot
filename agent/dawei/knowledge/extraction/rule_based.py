...
class RuleBasedExtractor(ExtractionStrategy):
    ...
    DEFAULT_TECH_TERMS = [
        ...
        # Frameworks
        "FastAPI", "Flask", "Django", "Spring", "React", "Vue", "Angular",
        # Databases
    ...
    def __init__(self, config: Dict[str, Any] | None = None):
        ...
        # Load dictionaries
        self.tech_terms = set(
            self.config.get("tech_dict", self.DEFAULT_TECH_TERMS)
        )
        ...
        self.org_patterns = [
            re.compile(p) for p in self.config.get(
                "org_patterns",
                self.DEFAULT_ORG_PATTERNS
            )
        ]

        # Relation patterns
        self.relation_patterns = self.config.get("relation_patterns", {
        ...
        for rel_type, patterns in self.relation_patterns.items():
            self.compiled_relations[rel_type] = [
